...
<body>
  <div class="container">
    ...
    <a href="http://localhost:4433/tracnghiem/tracnghiem/trangchu/"><button id="btnLogOut" class="btn btn-sm btn-danger"><i class="glyphicon glyphicon-log-in" aria-hidden="true"></i> Log Out</button></a>
    </div>
